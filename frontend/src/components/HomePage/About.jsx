...
const About = () => {
  return (
    <div>
    <section id='about' className='h-[100vh]  p-4 rounded-3xl flex  justify-center'>
      <div className='text-center'>
        ...
        <div className='text-xl w-[60%] flex items-center justify-center shadow-xl py-10 px-[2rem]'> At JournalForge, our mission is to empower researchers, scholars, and practitioners worldwide by providing a dynamic platform for the exchange of ideas and the publication of high-quality, peer-reviewed articles. We are committed to fostering academic excellence, promoting interdisciplinary collaboration, and driving innovation forward. Our dedication to advancing knowledge and promoting inclusivity ensures that diverse perspectives are valued and contribute to meaningful discoveries. Through our comprehensive resources and community-driven approach.</div>
